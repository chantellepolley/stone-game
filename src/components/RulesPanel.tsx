    ...
    <div className="rounded-xl border border-[#6b5f55] bg-[#504840] overflow-hidden shadow-md">
      ...
      {open && (
        <div className="px-3 pb-3 text-xs text-stone-light/70 space-y-2 border-t border-stone-accent/20 pt-2">
          ...
          <p><strong>Rolling:</strong> Roll 2 dice (faces 1-5 + Jester). Each die is a separate move. Doubles grant 4 moves.</p>
          <p><strong>Jester:</strong> The 6 face is a Jester. Rolling a Jester with any number X turns the roll into 4 moves of X.</p>
