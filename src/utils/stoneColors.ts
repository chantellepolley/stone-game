...
export const STONE_COLORS: StoneColor[] = [
  ...
  // ── Ultra Premium colors (50 coins each) ──
  {
    ...
    pulse: 'pulse-gold',
    gradient: 'conic-gradient(from 0deg, rgba(130,20,20,0.4) 0deg, rgba(130,20,20,0.4) 30deg, rgba(255,180,0,0.35) 30deg, rgba(255,180,0,0.35) 60deg, rgba(130,20,20,0.4) 60deg, rgba(130,20,20,0.4) 90deg, rgba(255,180,0,0.35) 90deg, rgba(255,180,0,0.35) 120deg, rgba(130,20,20,0.4) 120deg, rgba(130,20,20,0.4) 150deg, rgba(255,180,0,0.35) 150deg, rgba(255,180,0,0.35) 180deg, rgba(130,20,20,0.4) 180deg, rgba(130,20,20,0.4) 210deg, rgba(255,180,0,0.35) 210deg, rgba(255,180,0,0.35) 240deg, rgba(130,20,20,0.4) 240deg, rgba(130,20,20,0.4) 270deg, rgba(255,180,0,0.35) 270deg, rgba(255,180,0,0.35) 300deg, rgba(130,20,20,0.4) 300deg, rgba(130,20,20,0.4) 330deg, rgba(255,180,0,0.35) 330deg, rgba(255,180,0,0.35) 360deg)',
    gradientCrowned: 'conic-gradient(from 0deg, rgba(130,20,20,0.5) 0deg, rgba(130,20,20,0.5) 30deg, rgba(255,180,0,0.45) 30deg, rgba(255,180,0,0.45) 60deg, rgba(130,20,20,0.5) 60deg, rgba(130,20,20,0.5) 90deg, rgba(255,180,0,0.45) 90deg, rgba(255,180,0,0.45) 120deg, rgba(130,20,20,0.5) 120deg, rgba(130,20,20,0.5) 150deg, rgba(255,180,0,0.45) 150deg, rgba(255,180,0,0.45) 180deg, rgba(130,20,20,0.5) 180deg, rgba(130,20,20,0.5) 210deg, rgba(255,180,0,0.45) 210deg, rgba(255,180,0,0.45) 240deg, rgba(130,20,20,0.5) 240deg, rgba(130,20,20,0.5) 270deg, rgba(255,180,0,0.45) 270deg, rgba(255,180,0,0.45) 300deg, rgba(130,20,20,0.5) 300deg, rgba(130,20,20,0.5) 330deg, rgba(255,180,0,0.45) 330deg, rgba(255,180,0,0.45) 360deg)',
    premium: true,
    price: 50,
  },
  {
    ...
    ring: 'ring-yellow-500',
    pulse: 'pulse-gold',
    gradient: 'conic-gradient(from 0deg, rgba(190,30,30,0.4) 0deg, rgba(190,30,30,0.4) 30deg, rgba(200,170,55,0.35) 30deg, rgba(200,170,55,0.35) 60deg, rgba(190,30,30,0.4) 60deg, rgba(190,30,30,0.4) 90deg, rgba(200,170,55,0.35) 90deg, rgba(200,170,55,0.35) 120deg, rgba(190,30,30,0.4) 120deg, rgba(190,30,30,0.4) 150deg, rgba(200,170,55,0.35) 150deg, rgba(200,170,55,0.35) 180deg, rgba(190,30,30,0.4) 180deg, rgba(190,30,30,0.4) 210deg, rgba(200,170,55,0.35) 210deg, rgba(200,170,55,0.35) 240deg, rgba(190,30,30,0.4) 240deg, rgba(190,30,30,0.4) 270deg, rgba(200,170,55,0.35) 270deg, rgba(200,170,55,0.35) 300deg, rgba(190,30,30,0.4) 300deg, rgba(190,30,30,0.4) 330deg, rgba(200,170,55,0.35) 330deg, rgba(200,170,55,0.35) 360deg)',
    gradientCrowned: 'conic-gradient(from 0deg, rgba(190,30,30,0.5) 0deg, rgba(190,30,30,0.5) 30deg, rgba(200,170,55,0.45) 30deg, rgba(200,170,55,0.45) 60deg, rgba(190,30,30,0.5) 60deg, rgba(190,30,30,0.5) 90deg, rgba(200,170,55,0.45) 90deg, rgba(200,170,55,0.45) 120deg, rgba(190,30,30,0.5) 120deg, rgba(190,30,30,0.5) 150deg, rgba(200,170,55,0.45) 150deg, rgba(200,170,55,0.45) 180deg, rgba(190,30,30,0.5) 180deg, rgba(190,30,30,0.5) 210deg, rgba(200,170,55,0.45) 210deg, rgba(200,170,55,0.45) 240deg, rgba(190,30,30,0.5) 240deg, rgba(190,30,30,0.5) 270deg, rgba(200,170,55,0.45) 270deg, rgba(200,170,55,0.45) 300deg, rgba(190,30,30,0.5) 300deg, rgba(190,30,30,0.5) 330deg, rgba(200,170,55,0.45) 330deg, rgba(200,170,55,0.45) 360deg)',
    premium: true,
    price: 50,
  },
];
