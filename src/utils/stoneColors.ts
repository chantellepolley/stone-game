...
export const STONE_COLORS: StoneColor[] = [
  ...
  // ── Ultra Premium colors (50 coins each) ──
  {
    ...
    pulse: 'pulse-gold',
    gradient: 'radial-gradient(circle at 30% 25%, rgba(255,180,0,0.4) 0%, rgba(255,180,0,0.3) 15%, rgba(130,20,20,0.35) 25%, rgba(255,180,0,0.3) 35%, rgba(130,20,20,0.4) 50%, rgba(255,180,0,0.3) 65%, rgba(130,20,20,0.35) 80%, rgba(130,20,20,0.4) 100%)',
    gradientCrowned: 'radial-gradient(circle at 30% 25%, rgba(255,180,0,0.5) 0%, rgba(255,180,0,0.4) 15%, rgba(130,20,20,0.45) 25%, rgba(255,180,0,0.4) 35%, rgba(130,20,20,0.5) 50%, rgba(255,180,0,0.4) 65%, rgba(130,20,20,0.45) 80%, rgba(130,20,20,0.5) 100%)',
    premium: true,
    price: 50,
  },
  {
    ...
    ring: 'ring-yellow-500',
    pulse: 'pulse-gold',
    gradient: 'radial-gradient(circle at 30% 25%, rgba(200,170,55,0.4) 0%, rgba(200,170,55,0.3) 15%, rgba(190,30,30,0.35) 25%, rgba(200,170,55,0.3) 35%, rgba(190,30,30,0.4) 50%, rgba(200,170,55,0.3) 65%, rgba(190,30,30,0.35) 80%, rgba(190,30,30,0.4) 100%)',
    gradientCrowned: 'radial-gradient(circle at 30% 25%, rgba(200,170,55,0.5) 0%, rgba(200,170,55,0.4) 15%, rgba(190,30,30,0.45) 25%, rgba(200,170,55,0.4) 35%, rgba(190,30,30,0.5) 50%, rgba(200,170,55,0.4) 65%, rgba(190,30,30,0.45) 80%, rgba(190,30,30,0.5) 100%)',
    premium: true,
    price: 50,
  },
];
