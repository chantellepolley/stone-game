...
export const STONE_COLORS: StoneColor[] = [
  ...
  // ── Ultra Premium colors (50 coins each) ──
  {
    ...
    pulse: 'pulse-gold',
    gradient: 'conic-gradient(from 45deg, rgba(130,20,20,0.4) 0deg, rgba(255,180,0,0.35) 90deg, rgba(130,20,20,0.4) 180deg, rgba(255,180,0,0.35) 270deg, rgba(130,20,20,0.4) 360deg)',
    gradientCrowned: 'conic-gradient(from 45deg, rgba(130,20,20,0.5) 0deg, rgba(255,180,0,0.45) 90deg, rgba(130,20,20,0.5) 180deg, rgba(255,180,0,0.45) 270deg, rgba(130,20,20,0.5) 360deg)',
    premium: true,
    price: 50,
  },
  {
    ...
    ring: 'ring-yellow-500',
    pulse: 'pulse-gold',
    gradient: 'conic-gradient(from 45deg, rgba(190,30,30,0.4) 0deg, rgba(200,170,55,0.35) 90deg, rgba(190,30,30,0.4) 180deg, rgba(200,170,55,0.35) 270deg, rgba(190,30,30,0.4) 360deg)',
    gradientCrowned: 'conic-gradient(from 45deg, rgba(190,30,30,0.5) 0deg, rgba(200,170,55,0.45) 90deg, rgba(190,30,30,0.5) 180deg, rgba(200,170,55,0.45) 270deg, rgba(190,30,30,0.5) 360deg)',
    premium: true,
    price: 50,
  },
];
