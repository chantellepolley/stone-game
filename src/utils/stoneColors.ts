...
export const STONE_COLORS: StoneColor[] = [
  ...
  // ── Ultra Premium colors (50 coins each) ──
  {
    ...
    pulse: 'pulse-gold',
    gradient: 'repeating-linear-gradient(135deg, rgba(130,20,20,0.4) 0px, rgba(130,20,20,0.4) 5px, rgba(255,180,0,0.35) 5px, rgba(255,180,0,0.35) 10px)',
    gradientCrowned: 'repeating-linear-gradient(135deg, rgba(130,20,20,0.5) 0px, rgba(130,20,20,0.5) 5px, rgba(255,180,0,0.45) 5px, rgba(255,180,0,0.45) 10px)',
    premium: true,
    price: 50,
  },
  {
    ...
    ring: 'ring-yellow-500',
    pulse: 'pulse-gold',
    gradient: 'repeating-linear-gradient(135deg, rgba(190,30,30,0.4) 0px, rgba(190,30,30,0.4) 5px, rgba(200,170,55,0.35) 5px, rgba(200,170,55,0.35) 10px)',
    gradientCrowned: 'repeating-linear-gradient(135deg, rgba(190,30,30,0.5) 0px, rgba(190,30,30,0.5) 5px, rgba(200,170,55,0.45) 5px, rgba(200,170,55,0.45) 10px)',
    premium: true,
    price: 50,
  },
];
