...
export const STONE_COLORS: StoneColor[] = [
  ...
  // ── Ultra Premium colors (50 coins each) ──
  {
    ...
    pulse: 'pulse-gold',
    gradient: 'radial-gradient(ellipse 60% 50% at 20% 30%, rgba(255,180,0,0.4) 0%, transparent 70%), radial-gradient(ellipse 50% 70% at 75% 20%, rgba(255,180,0,0.35) 0%, transparent 65%), radial-gradient(ellipse 45% 55% at 55% 75%, rgba(255,180,0,0.35) 0%, transparent 60%), radial-gradient(ellipse 70% 40% at 40% 55%, rgba(130,20,20,0.4) 0%, transparent 70%), radial-gradient(ellipse 55% 65% at 85% 60%, rgba(130,20,20,0.35) 0%, transparent 65%), radial-gradient(ellipse 50% 50% at 10% 75%, rgba(130,20,20,0.4) 0%, transparent 60%), linear-gradient(135deg, rgba(130,20,20,0.3), rgba(130,20,20,0.35))',
    gradientCrowned: 'radial-gradient(ellipse 60% 50% at 20% 30%, rgba(255,180,0,0.5) 0%, transparent 70%), radial-gradient(ellipse 50% 70% at 75% 20%, rgba(255,180,0,0.45) 0%, transparent 65%), radial-gradient(ellipse 45% 55% at 55% 75%, rgba(255,180,0,0.45) 0%, transparent 60%), radial-gradient(ellipse 70% 40% at 40% 55%, rgba(130,20,20,0.5) 0%, transparent 70%), radial-gradient(ellipse 55% 65% at 85% 60%, rgba(130,20,20,0.45) 0%, transparent 65%), radial-gradient(ellipse 50% 50% at 10% 75%, rgba(130,20,20,0.5) 0%, transparent 60%), linear-gradient(135deg, rgba(130,20,20,0.4), rgba(130,20,20,0.45))',
    premium: true,
    price: 50,
  },
  {
    ...
    ring: 'ring-yellow-500',
    pulse: 'pulse-gold',
    gradient: 'radial-gradient(ellipse 60% 50% at 20% 30%, rgba(200,170,55,0.4) 0%, transparent 70%), radial-gradient(ellipse 50% 70% at 75% 20%, rgba(200,170,55,0.35) 0%, transparent 65%), radial-gradient(ellipse 45% 55% at 55% 75%, rgba(200,170,55,0.35) 0%, transparent 60%), radial-gradient(ellipse 70% 40% at 40% 55%, rgba(190,30,30,0.4) 0%, transparent 70%), radial-gradient(ellipse 55% 65% at 85% 60%, rgba(190,30,30,0.35) 0%, transparent 65%), radial-gradient(ellipse 50% 50% at 10% 75%, rgba(190,30,30,0.4) 0%, transparent 60%), linear-gradient(135deg, rgba(190,30,30,0.3), rgba(190,30,30,0.35))',
    gradientCrowned: 'radial-gradient(ellipse 60% 50% at 20% 30%, rgba(200,170,55,0.5) 0%, transparent 70%), radial-gradient(ellipse 50% 70% at 75% 20%, rgba(200,170,55,0.45) 0%, transparent 65%), radial-gradient(ellipse 45% 55% at 55% 75%, rgba(200,170,55,0.45) 0%, transparent 60%), radial-gradient(ellipse 70% 40% at 40% 55%, rgba(190,30,30,0.5) 0%, transparent 70%), radial-gradient(ellipse 55% 65% at 85% 60%, rgba(190,30,30,0.45) 0%, transparent 65%), radial-gradient(ellipse 50% 50% at 10% 75%, rgba(190,30,30,0.5) 0%, transparent 60%), linear-gradient(135deg, rgba(190,30,30,0.4), rgba(190,30,30,0.45))',
    premium: true,
    price: 50,
  },
];
